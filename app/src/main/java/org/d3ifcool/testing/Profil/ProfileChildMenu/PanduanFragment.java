...
public class PanduanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view = inflater.inflate(R.layout.fragment_panduan, container, false);

        Toolbar toolbar = view.findViewById(R.id.toolBarPanduan);
        ...
        ExpansionLayout expansionLayout1 = view.findViewById(R.id.expansionLayout);
        ...
        ExpansionLayout expansionLayout2 = view.findViewById(R.id.expansionLayout);
